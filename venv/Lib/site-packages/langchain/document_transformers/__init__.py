...
.. code-block::
    ...
    BaseDocumentTransformer --> <name>  # Examples: Doctranstimulantsransformer, DoctranTextTranslator
...
DEPRECATED_LOOKUP = {
    ...
    "Doctranstimulantsransformer": "langchain_community.document_transformers",
