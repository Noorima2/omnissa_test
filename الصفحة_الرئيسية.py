...
<h1 style="text-align:center;" class="blue-title">Liora</h1>
<h3 style="text-align:center; color:#305ed1;">مساعدك الآمن لإدارة وتلخيص معلوماتك الصحية</h3>
<p style="font-size:20px; text-align:center; margin:0 20px 18px 20px;">
مرحبًا بك في Liora — سجل تاريخك الطبي خطوة بخطوة بسهولة وسرية تامة. كل ما تحتاجه لمتابعة صحتك وتجهيز ملخص واضح لطبيبك أو لنفسك في متناول يدك.
</p>
</div>
...
# <div class="cards-row">
  <div class="info-card">
    <h4 style="color:#2551a3;">📋 تعريف الفكرة </h4>
    <div style="font-size:17px;">
    مساعد ذكي يرافقك في كل خطوة لرصد وحفظ بياناتك الصحية بتجربة عربية حديثة وسهلة.
    </div>
  </div>
  -
  <div class="info-card">
    ...
    <li>ملخص ذكي يمكنك طباعته أو مشاركته </li>
